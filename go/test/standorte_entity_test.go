...
func standorteBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("PASSANTENFREQUENZEN_ZUERICH_TEST_STANDORTE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["PASSANTENFREQUENZEN_ZUERICH_TEST_STANDORTE_ENTID"])
