...
const testSeed = `map[string]any{"entity": map[string]any{"frequenzen": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "standorte": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
