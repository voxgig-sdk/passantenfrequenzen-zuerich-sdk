...
type FrequenzenEntity struct {
	name    string
	client  *core.PassantenfrequenzenZuerichSDK
...
func NewFrequenzenEntity(client *core.PassantenfrequenzenZuerichSDK, entopts map[string]any) *FrequenzenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FrequenzenEntity) GetName() string { return e.name }
...
func (e *FrequenzenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FrequenzenEntity) Deleted() bool {
	return e.deleted
}


func (e *FrequenzenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFrequenzenEntity(e.client, opts)
}

func (e *FrequenzenEntity) Data(args ...any) any {
...
func (e *FrequenzenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Frequenzen; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FrequenzenEntity) DataTyped(data ...Frequenzen) Frequenzen {
	if len(data) > 0 {
		return typedFrom[Frequenzen](e.Data(asMap(data[0])))
	}
	return typedFrom[Frequenzen](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Frequenzen (all fields
// optional at the wire level).
func (e *FrequenzenEntity) MatchTyped(match ...Frequenzen) Frequenzen {
	if len(match) > 0 {
		return typedFrom[Frequenzen](e.Match(asMap(match[0])))
	}
	return typedFrom[Frequenzen](e.Match())
}
...
func (e *FrequenzenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FrequenzenEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *FrequenzenEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FrequenzenListMatch and returns []Frequenzen. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FrequenzenEntity) ListTyped(reqmatch FrequenzenListMatch, ctrl map[string]any) ([]Frequenzen, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Frequenzen](res), nil
}



func (e *FrequenzenEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FrequenzenEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FrequenzenEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FrequenzenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
