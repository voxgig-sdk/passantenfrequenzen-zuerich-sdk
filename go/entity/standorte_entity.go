...
func NewStandorteEntity(client *core.PassantenfrequenzenZuerichSDK, entopts map[string]any) *StandorteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StandorteEntity) GetName() string { return e.name }
...
func (e *StandorteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StandorteEntity) Deleted() bool {
	return e.deleted
}


func (e *StandorteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStandorteEntity(e.client, opts)
}

func (e *StandorteEntity) Data(args ...any) any {
...
func (e *StandorteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Standorte; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StandorteEntity) DataTyped(data ...Standorte) Standorte {
	if len(data) > 0 {
		return typedFrom[Standorte](e.Data(asMap(data[0])))
	}
	return typedFrom[Standorte](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Standorte (all fields
// optional at the wire level).
func (e *StandorteEntity) MatchTyped(match ...Standorte) Standorte {
	if len(match) > 0 {
		return typedFrom[Standorte](e.Match(asMap(match[0])))
	}
	return typedFrom[Standorte](e.Match())
}
...
func (e *StandorteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StandorteEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *StandorteEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StandorteListMatch and returns []Standorte. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *StandorteEntity) ListTyped(reqmatch StandorteListMatch, ctrl map[string]any) ([]Standorte, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Standorte](res), nil
}



func (e *StandorteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StandorteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StandorteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StandorteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
