...
import "github.com/voxgig-sdk/passantenfrequenzen-zuerich-sdk/go/core"
...
func makeErrorUtil(ctx *core.Context, err error) (any, error) {
	...
	sdkErr := &core.PassantenfrequenzenZuerichError{
	...
	if se, ok := err.(*core.PassantenfrequenzenZuerichError); ok {
		sdkErr.Code = se.Code
	}
