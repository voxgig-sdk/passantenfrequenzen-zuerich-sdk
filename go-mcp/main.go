// Command PassantenfrequenzenZuerich-mcp is an MCP server exposing the PassantenfrequenzenZuerich
// SDK as MCP tools.
//
// Two tools are registered:
//
//	PassantenfrequenzenZuerich_list  — list records of an entity
//	PassantenfrequenzenZuerich_load  — load a single record of an entity
//
