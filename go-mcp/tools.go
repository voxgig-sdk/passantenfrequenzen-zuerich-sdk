...
type Args struct {
	Entity string         `json:"entity" jsonschema:"frequenzen | standorte"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PassantenfrequenzenZuerichSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "passantenfrequenzen-zuerich_list",
		Description: "List records from PassantenfrequenzenZuerich. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "passantenfrequenzen-zuerich_load",
		Description: "Load a single record from PassantenfrequenzenZuerich. " +
...
func runOp(client *sdk.PassantenfrequenzenZuerichSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PassantenfrequenzenZuerichSDK, name string) (sdk.PassantenfrequenzenZuerichEntity, error) {
	switch strings.ToLower(name) {
	case "frequenzen":
		return client.Frequenzen(nil), nil
	case "standorte":
		return client.Standorte(nil), nil
