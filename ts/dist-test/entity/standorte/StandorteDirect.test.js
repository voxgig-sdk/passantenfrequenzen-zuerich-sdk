...
(0, node_test_1.describe)('StandorteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-standorte', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-standorte', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PASSANTENFREQUENZEN_ZUERICH_TEST_STANDORTE_ENTID'];
...
//# sourceMappingURL=StandorteDirect.test.js.map