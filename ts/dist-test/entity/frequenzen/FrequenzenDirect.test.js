...
(0, node_test_1.describe)('FrequenzenDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.PassantenfrequenzenZuerichSDK({
    ...
    (0, node_test_1.test)('direct-list-frequenzen', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-frequenzen', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.PASSANTENFREQUENZEN_ZUERICH_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PassantenfrequenzenZuerichSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['PASSANTENFREQUENZEN_ZUERICH_TEST_FREQUENZEN_ENTID'];
    ...
    const client = new __1.PassantenfrequenzenZuerichSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=FrequenzenDirect.test.js.map