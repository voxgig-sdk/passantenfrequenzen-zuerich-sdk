...
function envOverride(m) {
    if ('TRUE' === process.env.PASSANTENFREQUENZEN_ZUERICH_TEST_LIVE ||
        'TRUE' === process.env.PASSANTENFREQUENZEN_ZUERICH_TEST_OVERRIDE) {
    ...
    m.PASSANTENFREQUENZEN_ZUERICH_TEST_EXPLAIN = process.env.PASSANTENFREQUENZEN_ZUERICH_TEST_EXPLAIN || m.PASSANTENFREQUENZEN_ZUERICH_TEST_EXPLAIN;
    return m;
}
