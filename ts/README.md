# PassantenfrequenzenZuerich TypeScript SDK



The TypeScript SDK for the PassantenfrequenzenZuerich API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Frequenzen()` — each with a small set of operations (`list`)
...
| `tester(testopts?, sdkopts?)` | `PassantenfrequenzenZuerichSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `PassantenfrequenzenZuerichSDK.test(testopts?, sdkopts?)` | `PassantenfrequenzenZuerichSDK` | Create a test-mode client. |
...
| `client` | `client(): PassantenfrequenzenZuerichSDK` | Return the parent SDK client. |
...
├── src/
│   ├── PassantenfrequenzenZuerichSDK.ts        # Main SDK class
