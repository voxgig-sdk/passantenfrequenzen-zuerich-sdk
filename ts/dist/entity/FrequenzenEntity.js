...
exports.FrequenzenEntity = void 0;
const PassantenfrequenzenZuerichEntityBase_1 = require("../PassantenfrequenzenZuerichEntityBase");
// TODO: needs Entity superclass
class FrequenzenEntity extends PassantenfrequenzenZuerichEntityBase_1.PassantenfrequenzenZuerichEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'frequenzen';
        this.name_ = 'frequenzen';
        this.Name = 'Frequenzen';
    }
    make() {
        return new FrequenzenEntity(this._client, this.entopts());
    }
...
exports.FrequenzenEntity = FrequenzenEntity;
//# sourceMappingURL=FrequenzenEntity.js.map