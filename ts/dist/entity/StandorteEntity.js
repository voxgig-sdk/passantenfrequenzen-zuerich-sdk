...
class StandorteEntity extends PassantenfrequenzenZuerichEntityBase_1.PassantenfrequenzenZuerichEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'standorte';
        this.name_ = 'standorte';
        this.Name = 'Standorte';
    }
    make() {
        return new StandorteEntity(this._client, this.entopts());
    }
...
exports.StandorteEntity = StandorteEntity;
//# sourceMappingURL=StandorteEntity.js.map