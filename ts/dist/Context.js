...
const PassantenfrequenzenZuerichError_1 = require("./PassantenfrequenzenZuerichError");
...
class Context {
    ...
    error(code, msg) {
        return new PassantenfrequenzenZuerichError_1.PassantenfrequenzenZuerichError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
