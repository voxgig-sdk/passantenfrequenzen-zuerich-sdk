...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.PASSANTENFREQUENZENZUERICH_TEST_LIVE ||
    'TRUE' === process.env.PASSANTENFREQUENZENZUERICH_TEST_OVERRIDE
  ) {
  ...
  m.PASSANTENFREQUENZENZUERICH_TEST_EXPLAIN = process.env.PASSANTENFREQUENZENZUERICH_TEST_EXPLAIN || m.PASSANTENFREQUENZENZUERICH_TEST_EXPLAIN
