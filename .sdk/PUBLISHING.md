...
|---|---|---|
| `ts/` | @voxgig-sdk/passantenfrequenzen-zuerich-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/passantenfrequenzen-zuerich-sdk \
      --repository voxgig-sdk/passantenfrequenzen-zuerich-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/passantenfrequenzen-zuerich-sdk` shows it, and
`npm trust revoke @voxgig-sdk/passantenfrequenzen-zuerich-sdk --id=<id>` removes it.
