...
// PassantenfrequenzenZuerich SDK utility: fetcher

class PassantenfrequenzenZuerichFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PassantenfrequenzenZuerichSDK/1.0)';
    ...
    public static function call(PassantenfrequenzenZuerichContext $ctx, string $fullurl, array $fetchdef): array
    {
