...
// PassantenfrequenzenZuerich SDK clienttrack feature
...
class PassantenfrequenzenZuerichClienttrackFeature extends PassantenfrequenzenZuerichBaseFeature
{
    ...
    public function PostConstruct(PassantenfrequenzenZuerichContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PassantenfrequenzenZuerich-SDK';
