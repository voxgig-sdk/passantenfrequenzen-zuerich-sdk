...
// PassantenfrequenzenZuerich SDK metrics feature
...
class PassantenfrequenzenZuerichMetricsFeature extends PassantenfrequenzenZuerichBaseFeature
{
    ...
    private function _record(PassantenfrequenzenZuerichContext $ctx, bool $ok): void
    {
