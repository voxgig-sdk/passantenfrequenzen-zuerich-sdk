...
// PassantenfrequenzenZuerich SDK idempotency feature
...
class PassantenfrequenzenZuerichIdempotencyFeature extends PassantenfrequenzenZuerichBaseFeature
{
    ...
    private function _mutating(PassantenfrequenzenZuerichContext $ctx): bool
    {
