...
// PassantenfrequenzenZuerich SDK netsim feature
...
class PassantenfrequenzenZuerichNetsimFeature extends PassantenfrequenzenZuerichBaseFeature
{
    ...
    private function _simulate(PassantenfrequenzenZuerichContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PassantenfrequenzenZuerichContext $ctx, array $applied): void
    {
        $client = $this->client;
