...
// PassantenfrequenzenZuerich SDK rbac feature
...
class PassantenfrequenzenZuerichRbacFeature extends PassantenfrequenzenZuerichBaseFeature
{
    ...
    private function _required(PassantenfrequenzenZuerichContext $ctx): ?string
    {
    ...
    private function _reject(PassantenfrequenzenZuerichContext $ctx, string $required): void
    {
    ...
    private function _track(PassantenfrequenzenZuerichContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
