...
// PassantenfrequenzenZuerich SDK timeout feature
...
class PassantenfrequenzenZuerichTimeoutFeature extends PassantenfrequenzenZuerichBaseFeature
{
    ...
    private function _with_timeout(PassantenfrequenzenZuerichContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PassantenfrequenzenZuerichContext $_ctx, float $ms): void
    {
        $client = $this->client;
