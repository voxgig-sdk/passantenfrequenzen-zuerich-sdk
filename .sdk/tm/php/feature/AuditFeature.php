...
// PassantenfrequenzenZuerich SDK audit feature
...
class PassantenfrequenzenZuerichAuditFeature extends PassantenfrequenzenZuerichBaseFeature
{
    ...
    private function _emit(PassantenfrequenzenZuerichContext $ctx, string $outcome): void
    {
