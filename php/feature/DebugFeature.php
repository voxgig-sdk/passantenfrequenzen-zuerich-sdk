...
// PassantenfrequenzenZuerich SDK debug feature
...
class PassantenfrequenzenZuerichDebugFeature extends PassantenfrequenzenZuerichBaseFeature
{
    ...
    private function _finish(PassantenfrequenzenZuerichContext $ctx, bool $ok): void
    {
