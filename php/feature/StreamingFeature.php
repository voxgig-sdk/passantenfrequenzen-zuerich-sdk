...
// PassantenfrequenzenZuerich SDK streaming feature
...
class PassantenfrequenzenZuerichStreamingFeature extends PassantenfrequenzenZuerichBaseFeature
{
    ...
    private function _iterate(PassantenfrequenzenZuerichResult $result): \Generator
    {
    ...
    private function _streamable(PassantenfrequenzenZuerichContext $ctx): bool
    {
