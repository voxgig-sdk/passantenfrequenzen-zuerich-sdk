...
// PassantenfrequenzenZuerich SDK telemetry feature
...
class PassantenfrequenzenZuerichTelemetryFeature extends PassantenfrequenzenZuerichBaseFeature
{
    ...
    private function _close(PassantenfrequenzenZuerichContext $ctx, bool $ok): void
    {
