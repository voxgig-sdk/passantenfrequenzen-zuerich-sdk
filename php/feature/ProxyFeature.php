...
// PassantenfrequenzenZuerich SDK proxy feature
...
class PassantenfrequenzenZuerichProxyFeature extends PassantenfrequenzenZuerichBaseFeature
{
    ...
    public function init(PassantenfrequenzenZuerichContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PassantenfrequenzenZuerichContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
