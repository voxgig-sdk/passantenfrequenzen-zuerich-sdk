...
// PassantenfrequenzenZuerich SDK cache feature
...
class PassantenfrequenzenZuerichCacheFeature extends PassantenfrequenzenZuerichBaseFeature
{
    ...
    private function _through(PassantenfrequenzenZuerichContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
