...
// PassantenfrequenzenZuerich SDK ratelimit feature
...
class PassantenfrequenzenZuerichRatelimitFeature extends PassantenfrequenzenZuerichBaseFeature
{
    ...
    private function _acquire(PassantenfrequenzenZuerichContext $ctx): void
    {
    ...
    private function _track(PassantenfrequenzenZuerichContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
