...
// PassantenfrequenzenZuerich SDK paging feature
...
class PassantenfrequenzenZuerichPagingFeature extends PassantenfrequenzenZuerichBaseFeature
{
    ...
    private function _is_list(PassantenfrequenzenZuerichContext $ctx): bool
    {
