...
// PassantenfrequenzenZuerich SDK utility: graphql
//
...
class PassantenfrequenzenZuerichGraphql
{
    ...
    // equivalent.
    public static function body(PassantenfrequenzenZuerichContext $ctx): mixed
    {
    ...
    public static function errors(PassantenfrequenzenZuerichContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
