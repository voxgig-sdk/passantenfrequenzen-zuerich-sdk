...
// PassantenfrequenzenZuerich SDK utility: make_options

class PassantenfrequenzenZuerichMakeOptions
{
    ...
    public static function call(PassantenfrequenzenZuerichContext $ctx): array
    {
        ...
        //
        // `PassantenfrequenzenZuerichSchema::optspec()` is built from the model:
        ...
        $optspec = PassantenfrequenzenZuerichSchema::optspec();
