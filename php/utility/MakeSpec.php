...
// PassantenfrequenzenZuerich SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class PassantenfrequenzenZuerichMakeSpec
{
    public static function call(PassantenfrequenzenZuerichContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = PassantenfrequenzenZuerichGraphql::CONTENT_TYPE;
        } else {
