...
// PassantenfrequenzenZuerich SDK Standorte entity
...
class StandorteEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StandorteEntity($this->_client, $opts);
    }

    /**
     * @param Standorte|array $args Standorte data (assoc-array) to store.
     */
    ...
    /**
     * @return Standorte|array The current Standorte data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Standorte fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Standorte fields).
     */
    ...
    /**
     * List Standorte items matching the given filter.
     *
     * @param StandorteListMatch|array|null $reqmatch Match filter (any subset
     *   of Standorte fields) as an assoc-array; StandorteListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Standorte[]|array A list of Standorte items as assoc-arrays at
