...
// PassantenfrequenzenZuerich SDK utility type

class PassantenfrequenzenZuerichUtility
{
    ...
    public static function copy(PassantenfrequenzenZuerichUtility $src): PassantenfrequenzenZuerichUtility
    {
        $u = new PassantenfrequenzenZuerichUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
