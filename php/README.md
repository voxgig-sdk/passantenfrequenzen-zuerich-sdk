# PassantenfrequenzenZuerich PHP SDK



The PHP SDK for the PassantenfrequenzenZuerich API — an entity-oriented client using PHP conventions.
...
print_r(array_map(fn($item) => $item->data_get(), $frequenzen));
```
...
```
php/
├── passantenfrequenzenzuerich_sdk.php          -- Main SDK class
...
The main class (`passantenfrequenzenzuerich_sdk.php`) exports the SDK class
