...
// PassantenfrequenzenZuerich SDK pipeline test
//
...
{
    private static function utility(): PassantenfrequenzenZuerichUtility
    {
        return new PassantenfrequenzenZuerichUtility();
    }
    ...
    private static function ctx(array $over = []): PassantenfrequenzenZuerichContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new PassantenfrequenzenZuerichContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new PassantenfrequenzenZuerichOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof PassantenfrequenzenZuerichError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new PassantenfrequenzenZuerichOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = PassantenfrequenzenZuerichMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new PassantenfrequenzenZuerichOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = PassantenfrequenzenZuerichMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new PassantenfrequenzenZuerichOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = PassantenfrequenzenZuerichMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PassantenfrequenzenZuerichSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = PassantenfrequenzenZuerichMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new PassantenfrequenzenZuerichResponse([]),
            'result' => new PassantenfrequenzenZuerichResult([]),
        ]);
        [, $err] = PassantenfrequenzenZuerichMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new PassantenfrequenzenZuerichSpec([]),
            'response' => null,
            'result' => new PassantenfrequenzenZuerichResult([]),
        ]);
        [, $err] = PassantenfrequenzenZuerichMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new PassantenfrequenzenZuerichSpec(['step' => 's']),
            'response' => new PassantenfrequenzenZuerichResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new PassantenfrequenzenZuerichResult([]),
        ]);
        [, $err] = PassantenfrequenzenZuerichMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new PassantenfrequenzenZuerichSpec(['step' => 's']),
            'response' => new PassantenfrequenzenZuerichResponse(self::resp(200, ['v' => 1])),
            'result' => new PassantenfrequenzenZuerichResult([]),
        ]);
        [, $err] = PassantenfrequenzenZuerichMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new PassantenfrequenzenZuerichSpec(['step' => 's']),
            'response' => new PassantenfrequenzenZuerichResponse(self::resp(200, ['v' => 2])),
            'result' => new PassantenfrequenzenZuerichResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        PassantenfrequenzenZuerichMakeResponse::call($ctx);
    ...
    {
        $preset = new PassantenfrequenzenZuerichResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new PassantenfrequenzenZuerichSpec([]),
            'response' => new PassantenfrequenzenZuerichResponse([]),
            'result' => new PassantenfrequenzenZuerichResult([]),
        ...
        [$got, $err] = PassantenfrequenzenZuerichMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new PassantenfrequenzenZuerichResult([])]);
        [, $err] = PassantenfrequenzenZuerichMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new PassantenfrequenzenZuerichSpec([]), 'result' => null]);
        [, $err] = PassantenfrequenzenZuerichMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PassantenfrequenzenZuerichSpec(['step' => 's']),
            'result' => new PassantenfrequenzenZuerichResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new PassantenfrequenzenZuerichOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PassantenfrequenzenZuerichMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PassantenfrequenzenZuerichSpec(['step' => 's']),
            'result' => new PassantenfrequenzenZuerichResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new PassantenfrequenzenZuerichOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PassantenfrequenzenZuerichMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PassantenfrequenzenZuerichResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new PassantenfrequenzenZuerichSpec([]),
            'result' => new PassantenfrequenzenZuerichResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = PassantenfrequenzenZuerichMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PassantenfrequenzenZuerichMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new PassantenfrequenzenZuerichError('boom', 'boom');
        $utility->fetcher = function (PassantenfrequenzenZuerichContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PassantenfrequenzenZuerichSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = PassantenfrequenzenZuerichMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (PassantenfrequenzenZuerichContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = PassantenfrequenzenZuerichMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(PassantenfrequenzenZuerichResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        PassantenfrequenzenZuerichMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (PassantenfrequenzenZuerichContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PassantenfrequenzenZuerichSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = PassantenfrequenzenZuerichMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new PassantenfrequenzenZuerichResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new PassantenfrequenzenZuerichSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = PassantenfrequenzenZuerichMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = PassantenfrequenzenZuerichMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = PassantenfrequenzenZuerichMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new PassantenfrequenzenZuerichResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, PassantenfrequenzenZuerichDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new PassantenfrequenzenZuerichResult(['ok' => false])]);
        $this->expectException(PassantenfrequenzenZuerichError::class);
        PassantenfrequenzenZuerichDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new PassantenfrequenzenZuerichResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', PassantenfrequenzenZuerichMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        PassantenfrequenzenZuerichMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new PassantenfrequenzenZuerichBaseFeature();
        $b = new PassantenfrequenzenZuerichBaseFeature();
        PassantenfrequenzenZuerichFeatureAdd::call($ctx, $a);
        PassantenfrequenzenZuerichFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): PassantenfrequenzenZuerichBaseFeature
    {
        $f = new PassantenfrequenzenZuerichBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        PassantenfrequenzenZuerichFeatureAdd::call($ctx, self::named_feature('a'));
        PassantenfrequenzenZuerichFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        PassantenfrequenzenZuerichFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        PassantenfrequenzenZuerichFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        PassantenfrequenzenZuerichFeatureAdd::call($ctx, $replace);
        ...
        PassantenfrequenzenZuerichFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): PassantenfrequenzenZuerichContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new PassantenfrequenzenZuerichSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PassantenfrequenzenZuerichPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        PassantenfrequenzenZuerichPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new PassantenfrequenzenZuerichResponse(['headers' => null]),
            'result' => new PassantenfrequenzenZuerichResult([]),
        ]);
        PassantenfrequenzenZuerichResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        PassantenfrequenzenZuerichResultBody::call($ctx);
