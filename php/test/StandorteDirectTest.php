...
class StandorteDirectTest extends TestCase
{
    public function test_direct_list_standorte(): void
    {
        $setup = standorte_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-standorte", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function standorte_direct_setup($mockres)
{
