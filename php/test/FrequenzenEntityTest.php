...
class FrequenzenEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set PASSANTENFREQUENZENZUERICH_TEST_FREQUENZEN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function frequenzen_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("PASSANTENFREQUENZENZUERICH_TEST_FREQUENZEN_ENTID");
