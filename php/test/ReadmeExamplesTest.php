...
// PassantenfrequenzenZuerich SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PassantenfrequenzenZuerichSDK::test)
...
{
    private const SDK_CLASS = 'PassantenfrequenzenZuerichSDK';
    ...
    private const SDK_BASE = 'passantenfrequenzenzuerich_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../passantenfrequenzenzuerich_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
