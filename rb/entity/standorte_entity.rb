...
class StandorteEntity
  ...
  def make
    opts = @_entopts.dup
    StandorteEntity.new(@_client, opts)
  end
  ...
  # @return [Standorte, Hash] the current Standorte data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Standorte fields)
  def match_get
  ...
  #
  # @param reqmatch [StandorteListMatch, Hash, nil] match filter (any subset of
  #   Standorte fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Standorte>, Array] the matching Standorte items; raises PassantenfrequenzenZuerichError on failure
