...
#      offline in seeded test mode (PassantenfrequenzenZuerichSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "PassantenfrequenzenZuerich_sdk.rb")
  SDK_CLASS = "PassantenfrequenzenZuerichSDK"
  ...
  SDK_BASE = "PassantenfrequenzenZuerich_sdk"
