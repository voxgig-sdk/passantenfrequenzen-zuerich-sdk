# PassantenfrequenzenZuerich SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # PassantenfrequenzenZuerichSDK.new, not PassantenfrequenzenZuerichSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    PassantenfrequenzenZuerichSDK.new(opts)
  end
