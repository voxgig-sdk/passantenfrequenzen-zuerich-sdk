...
local FrequenzenEntity = {}
FrequenzenEntity.__index = FrequenzenEntity


function FrequenzenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FrequenzenEntity)
  self._name = "frequenzen"
  self._client = client
...
function FrequenzenEntity:get_name()
  return self._name
end


function FrequenzenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FrequenzenEntity.new(self._client, opts)
end
...
function FrequenzenEntity:mark_deleted()
  self._deleted = true
end


function FrequenzenEntity:deleted()
  return true == self._deleted
end


function FrequenzenEntity:data_set(args)
  if args ~= nil then
...
function FrequenzenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FrequenzenEntity:match_set(args)
  if args ~= nil then
...
function FrequenzenEntity:match_get()
...
function FrequenzenEntity:stream(action, args, callopts)
...
---@param reqmatch FrequenzenListMatch
---@param ctrl? table
---@return Frequenzen[]
---@return string? err
function FrequenzenEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function FrequenzenEntity:_run_op(ctx, post_done)
  local utility = self._utility
