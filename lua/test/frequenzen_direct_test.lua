...
describe("FrequenzenDirect", function()
  it("should direct-list-frequenzen", function()
    local setup = frequenzen_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-frequenzen", setup.live and "live" or "unit")
