...
function runner.env_override(m)
  local live = runner.getenv("PASSANTENFREQUENZENZUERICH_TEST_LIVE")
  local override = runner.getenv("PASSANTENFREQUENZENZUERICH_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PASSANTENFREQUENZENZUERICH_TEST_EXPLAIN")
