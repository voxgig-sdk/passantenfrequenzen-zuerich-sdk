...
function runner.env_override(m)
  local live = runner.getenv("PASSANTENFREQUENZEN_ZUERICH_TEST_LIVE")
  local override = runner.getenv("PASSANTENFREQUENZEN_ZUERICH_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PASSANTENFREQUENZEN_ZUERICH_TEST_EXPLAIN")
