...
describe("StandorteDirect", function()
  it("should direct-list-standorte", function()
    local setup = standorte_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-standorte", setup.live and "live" or "unit")
