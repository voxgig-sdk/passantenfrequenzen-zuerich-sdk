...
from passantenfrequenzenzuerich_sdk.passantenfrequenzenzuerich_types import (
    Frequenzen,
    FrequenzenListMatch,
)
...
class FrequenzenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FrequenzenEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Frequenzen]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Frequenzen().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
