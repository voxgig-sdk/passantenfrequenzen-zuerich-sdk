...
from passantenfrequenzenzuerich_sdk.core.control import PassantenfrequenzenZuerichControl
...
from passantenfrequenzenzuerich_sdk.core.helpers import get_ctx_prop, to_map
...
class PassantenfrequenzenZuerichContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = PassantenfrequenzenZuerichControl()
        ...
        if isinstance(sp, PassantenfrequenzenZuerichSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, PassantenfrequenzenZuerichResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, PassantenfrequenzenZuerichResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return PassantenfrequenzenZuerichOperation({})
    ...
    def make_error(self, code, msg):
        return PassantenfrequenzenZuerichError(code, msg, self)
