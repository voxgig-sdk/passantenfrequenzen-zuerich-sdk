...
from passantenfrequenzenzuerich_sdk.utility import register

# Load features
from passantenfrequenzenzuerich_sdk.feature.base_feature import PassantenfrequenzenZuerichBaseFeature
from passantenfrequenzenzuerich_sdk.features import _has_feature, _make_feature
...
class PassantenfrequenzenZuerichSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = PassantenfrequenzenZuerichUtility()
        self._utility = utility

        from passantenfrequenzenzuerich_sdk.config import shared_config
    ...
    def get_utility(self):
        return PassantenfrequenzenZuerichUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PassantenfrequenzenZuerichSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Frequenzen(self, data=None) -> "FrequenzenEntity":
        ...
        from passantenfrequenzenzuerich_sdk.entity.frequenzen_entity import FrequenzenEntity
    ...
    def Standorte(self, data=None) -> "StandorteEntity":
        ...
        from passantenfrequenzenzuerich_sdk.entity.standorte_entity import StandorteEntity
