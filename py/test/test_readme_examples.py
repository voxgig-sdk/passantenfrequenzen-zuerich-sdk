# PassantenfrequenzenZuerich SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PassantenfrequenzenZuerichSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PassantenfrequenzenZuerichSDK(...) and PassantenfrequenzenZuerichSDK.test(...) become
#      PassantenfrequenzenZuerichSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "passantenfrequenzenzuerich_sdk"
_SDK_CLASS = "PassantenfrequenzenZuerichSDK"
