...
func registerSDKWords(r *eng.Registry, client *sdk.PassantenfrequenzenZuerichSDK) {
...
func runOp(client *sdk.PassantenfrequenzenZuerichSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
