...
AQL-driven CLI and REPL for the PassantenfrequenzenZuerich SDK. Positional arguments are
...
```sh
go build -o passantenfrequenzen-zuerich-cli ./...
```
...
./passantenfrequenzen-zuerich-cli load 1 frequenzen
./passantenfrequenzen-zuerich-cli load '{id:1}' frequenzen
